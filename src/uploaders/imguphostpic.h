...
#ifndef IMGUPHOSTPIC_H
#define IMGUPHOSTPIC_H
...
class ImgUpHostPic: public ImgUp
{
    Q_OBJECT
...
public:
    ImgUpHostPic(QWidget *parent, QString filePath=QString());

protected:
    virtual void postUploadRequest() Q_DECL_OVERRIDE;
    void sendFile();
    void showUploadPage(QString filename);

private slots:
    void imageUploaded();
    void gotPageForCookie();
};

#endif // IMGUPHOSTPIC_H
